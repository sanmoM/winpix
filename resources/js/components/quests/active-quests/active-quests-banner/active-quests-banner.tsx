                    ...
                    <Banner src={"/storage/" + slide.image} key={index} containerClass="h-[80vh] md:h-[60vh] lg:h-[80vh]">
                        <div className={cn("absolute inset-0 bg-black/50 flex w-full h-full justify-center items-center md:items-end md:justify-start text-white !text-center md:text-right md:p-8", direction === "right" && "md:justify-start")}>
                            <div className="relative z-10 p-8 md:p-12 flex flex-col gap-3 md:gap-4 text-white items-center md:items-start">
                                ...
                                {/* Info Bar */}
                                <div className={cn("flex justify-center md:justify-end flex-wrap items-center gap-x-6 gap-y-3 text-sm md:text-lg info w-fit", direction === "right" && "ml-auto")}>
                                ...
                                {/* Description Text */}
                                <p className={cn("text-xs md:text-base text-gray-200 max-w-3xl leading-relaxed description !text-left", direction === "right" && "md:!text-right")}>
                                ...
                                {/* Action Buttons */}
                                <div className={cn("flex flex-row items-center justify-center md:justify-end gap-4 pt-4 buttons w-fit", direction === "right" && "md:ml-auto")}>
