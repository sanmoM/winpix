...
export default function RedeemCard({ src, imgClassName, title, description }: { src: string, imgClassName?: string, title: string, description: string }) {
    return (
        <div className="border p-4 bg-bg-primary dark:bg-[#0B1120] rounded-lg">
            <img src={"/storage/" + src} alt="redeem" className={cn(`w-[75%] mx-auto mb-3`, imgClassName)} />
