...
//                         <PrizeCard key={index} number={index + 1} title={`${prize?.title}`} amount={prize.coin} containerClassName='w-full' />
//                     ))
//                 }
//             </div>
//             {
...
//                         {
//                             prizes?.slice(5).map((prize, index) => (
//                                 <PrizeCard key={index} number={index + 1} title={`${prize.prizeId + 1}`} amount={prize.coin} containerClassName='w-full' />
//                             ))
//                         }
//                     </div>
//                 )
...
//                     <BorderButton
//                         onClick={() => {
//                             setIsViewingAllPrizes(!isViewingAllPrizes)
//                         }}
