...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      className={cn(
        // base styles
        "flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-md px-2 outline-hidden text-sidebar-foreground ring-sidebar-ring",
        ...
        size === "sm" && "text-xs",
        size === "md" && "text-sm",
        // your custom active state
        "data-[active=true]:bg-gray-400 data-[active=true]:text-primary-color",
        // optional hiding rule
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
