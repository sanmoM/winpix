...
export default function ViewUser() {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div
                className="flex max-w-xl flex-col space-y-4 p-6"
            >
                <ImageInput image={user.image ? "/storage/" + user.image : "/images/user-avatar.png"} alt="User Image" wrapperClassName='aspect-square w-[200px]' />
