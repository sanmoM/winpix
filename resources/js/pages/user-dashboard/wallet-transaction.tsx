...
export default function WalletTransaction({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs as any}>
            ...
            <div className="mt-4 grid grid-cols-2 lg:grid-cols-3 gap-4 h-fit lg:w-fit mb-4 mx-4 lg:mx-auto">

                <div className=' bg-bg-primary p-4 lg:px-8 rounded-sm flex items-center gap-6 h-fit  lg:max-w-xs'>
